...
class Router:
    ...
    '''
    def __init__(self, name:str, tags:Union[str,List[str]],prefix:Union[str,None]=None, base:Union[str,Tuple[str]]='applications', dependencies:List[Depends]=None):
...
class RouterManager:
    def __init__(self, routers:List[Union[dict,Router]], base:Union[str,Tuple[str]]='applications'):
        self.routers = []
    ...
    def add_routers_to(self, app:Union[FastAPI,APIRouter]):
